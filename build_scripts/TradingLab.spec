...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "apps.auth_agent.pinned_keys",
        "apps.auth_agent.http_service",
        "apps.launcher.build_defaults",
        "apps.core",
        "apps.core.recovery_command",
        "apps.core.runner",
        ...
        "apps.ui.runner",
        "apps.ui.components",
        "apps.ui.components.manual_review_panel",
        "apps.ui.design",
        ...
        "packages.security",
        "packages.licensing",
        "packages.licensing.lease",
        "packages.licensing.product_key",

...
class MessageType(StrEnum):
    ...
    UI_IQOPTION_LOGIN_COMMAND = "UI_IQOPTION_LOGIN_COMMAND"
    UI_IQOPTION_LOGIN_ACK = "UI_IQOPTION_LOGIN_ACK"
    UI_UPDATE_IQOPTION_RISK_CONFIG_COMMAND = "UI_UPDATE_IQOPTION_RISK_CONFIG_COMMAND"
    UI_UPDATE_IQOPTION_RISK_CONFIG_ACK = "UI_UPDATE_IQOPTION_RISK_CONFIG_ACK"
    UI_IQOPTION_BOT_CONTROL_COMMAND = "UI_IQOPTION_BOT_CONTROL_COMMAND"
    UI_IQOPTION_BOT_CONTROL_ACK = "UI_IQOPTION_BOT_CONTROL_ACK"

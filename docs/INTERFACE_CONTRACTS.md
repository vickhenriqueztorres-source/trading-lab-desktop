...
> **Nota:** Este arquivo é o espelho canônico do documento localizado na raiz do repositório: [`INTERFACE_CONTRACTS.md`](../INTERFACE_CONTRACTS.md).

Consulte o documento mestre na raiz do repositório ou o conteúdo completo abaixo:
